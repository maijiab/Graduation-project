...
<head>
    ...
    <script type="text/javascript">
        ...
        function gotopage(page){
            window.location.href="${pageContext.request.contextPath}/adminEvaluate_findPageBean?page="+page+"";
        }
    </script>
</head>
<body>
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div id="page-inner">
            <form id="Form1" name="Form1" action="evaluate.jsp" method="post">
                <table class="table" >
                    ...
                    <s:iterator var="e" value="list" status="status">
                        <tr>
                            <td>
                            ...
                            <td>
                                <s:date name="data" format="yyyy-MM-dd HH:mm:ss"/>
                            </td>
                            <td  >
                                <a href="${pageContext.request.contextPath}/adminEvaluate_delete.action?eid=<s:property value="eid"/>"  onclick="return confirm('确定要删除吗？')">
                                    删除
                                </a>
                            </td>
