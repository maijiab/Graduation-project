                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="panel panel-danger">
                        ...
                        <div class="panel-body">
                            ...
                            <form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/adminCategory_<s:if test="cid == null">add</s:if><s:else>edit</s:else>" method="post" enctype="multipart/form-data">
