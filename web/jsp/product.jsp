...
<head>
    ...
    <script type="text/javascript">
        //传递当前页和cid
        function gotopage(page,csid){
            window.location.href="${pageContext.request.contextPath}/userProduct_findByCSid?page="+page+"&csid="+csid+"";
        }
    </script>
</head>
...
<div class="breadcrumb-area">
    <div class="container">
        <ol class="breadcrumb">
            ...
            <li class="active"> <s:property value="csname"/></li>
        </ol>
    </div>
</div>
<!-- breadcrumb end -->
                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active">
                                    ...
                                    <div class="col-md-4 col-sm-6">
                                        <div class="product-wrapper  mb-40 mrg-nn-xs ">
                                            <div class="product-img">
                                                <a href="${pageContext.request.contextPath}/jsp/userProduct_findByPdid?pid=${pid}&csid=<s:property value="#cs.csid"/>&cid = <s:property value="#c.cid"/>" target="_blank">
                            ...
                            <div class="pagination">
                                ...
                                <s:if test="page != 1">
                                    <%--跳转到首页 --%>
                                    <a href="javascript:gotopage(1,${csid})" class="firstPage">首页</a>
                                    <%--上一页 --%>
                                    <li> <a href="javascript:gotopage(${page}-1,${csid})" class="previousPage"><i class="fa fa-angle-left"></i></a></li>
                                </s:if>
                                <s:iterator var="num" begin="%{startIndex}" end="%{endIndex}">
                                    ...
                                    <s:else>
                                    <li> <a href="javascript:gotopage(${num},${csid})">${num}</a></li>
                                    </s:else>
                                </s:iterator>
                                <s:if test="page != pageCount">
                                    <%--下一页 --%>
                                    <li><a href="javascript:gotopage(${page}+1,${csid})" class="nextPage"><i class="fa fa-angle-right"></i></a></li>
                                    <%--跳转到尾页 --%>
                                    <a href="javascript:gotopage(${pageCount},${csid})"class="lastPage">尾页 </a>
                                </s:if>
                                </ul>
                            </div>
                        </div>
